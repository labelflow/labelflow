/*
  ...
  - The values [community,starter,pro,enterprise] on the enum `WorkspacePlan` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "WorkspacePlan_new" AS ENUM ('Community', 'Starter', 'Pro', 'Enterprise');
