      ...
      >
        ...
        >
          ...
          <Text textAlign="justify">
            ...
            <Link href="https://www.sterblue.com" isExternal color="brand.600">
              Sterblue
            </Link>
            ...
            <br />
            <br />
            Millions of images have been processed on the platform. We have used
            AI to detect discrepancies (corrosion, cracks, vegetation, etc.), to
            locate assets in space, to generate automatic flight paths for
            ...
            built AI training pipeline using tens of open source frameworks and
            ecosystem partners, we integrated real users in the loop and ... we
            showed some results.
            <br />
            <br />
            ...
            <b>
              ...
              , we now want to support every AI-applied company in the world to
