...
describe("Image resolver test suite", () => {
  ...
  test.skip("should query images when database is empty", async () => {
  ...
  test.skip("should query image that does not exist", async () => {
    await expect(
      client.query({
        query: gql`
  ...
  test.skip("should fail when we want to create an image when there is no dataset created", async () => {
    expect.assertions(1);
  ...
  test.skip("should create an image with the correct name when we want to create an image with Blob when there is a dataset", async () => {
  ...
  test.skip("should create an image with the correct name when we want to create an image with url when there is a dataset", async () => {
    await createDataset("Test dataset");
  ...
  test.skip("should create an image with a custom id", async () => {
    await createDataset("Test dataset");
  ...
  test.skip("should create an image with the given createdAt value", async () => {
    await createDataset("Test dataset");
  ...
  test.skip("should query images linked to a dataset", async () => {
  ...
  test.skip("should query all the images ignoring with which datasets there are linked", async () => {
    await createDataset("Test dataset 1", "dataset 1");
    await createDataset("Test dataset 2", "dataset 2");
  ...
  test.skip("should query paginated images", async () => {
    await createDataset("Test dataset 1", "dataset 1");
    await createDataset("Test dataset 2", "dataset 2");
  ...
  test.skip("should query an image with his labels", async () => {
    await createDataset("Test dataset");
  ...
  test("should count the images", async () => {
    // await createDataset("Test dataset");
    ...
    const queryResult = await client.query({
      query: gql`
        query getImagesNumber {
          imagesAggregates(where: { datasetId: "example" }) {
            totalCount
          }
        }
      `,
    ...
    expect(queryResult.data.imagesAggregates.totalCount).toEqual(1);
  });
});
