...
export const generateHtml = (props: {
  ...
  <mj-body background-color="${theme.colors.gray["100"]}" color="${theme.colors.gray["800"]}" font-family="Inter">
    ...
    <mj-section background-repeat="repeat" background-size="auto" padding-bottom="0px" padding-top="20px" padding="20px 0px 20px 0px" text-align="center" vertical-align="top">
      <mj-column>
        ...
        <mj-text align="center" color="${theme.colors.gray["800"]}" font-family="Inter" font-size="11px" line-height="22px" padding-bottom="0px" padding-top="0px" padding="0px 20px 0px 20px">
