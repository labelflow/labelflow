...
export const generateHtml = (props: {
  ...
  <mj-body background-color="${theme.colors.gray["100"]}" color="${theme.colors.gray["800"]}" font-family="Open Sans, Helvetica, Arial, sans-serif">
    <mj-section background-repeat="repeat" background-size="auto" padding-bottom="0px" padding-top="0px" padding="20px 0px 20px 0px" text-align="center" vertical-align="top">
      <mj-column>
        <mj-text align="left" color="${theme.colors.gray["800"]}" font-family="Open Sans, Helvetica, Arial, sans-serif" font-size="11px" line-height="22px" padding-bottom="0px" padding-top="0px" padding="0px 0px 0px 25px">
          <p style="text-align: center; margin: 10px 0;">LabelFlow activation&nbsp;| <a target="_blank" rel="noopener noreferrer" href="${viewOnlineLink}"><span style="color:${theme.colors.gray["800"]}; text-decoration: underline"> View online version</span></a></p>
        </mj-text>
      </mj-column>
    </mj-section>
    ...
    <mj-section background-color="#ffffff" background-repeat="repeat" background-size="auto" padding-bottom="70px" padding-top="30px" padding="20px 0px 20px 0px" text-align="center" vertical-align="top">
      <mj-column>
        ...
        <mj-text align="left" color="${theme.colors.gray["800"]}" font-family="Open Sans, Helvetica, Arial, sans-serif" font-size="13px" line-height="22px" padding-bottom="0px" padding-left="50px" padding-right="50px" padding-top="0px" padding="0px 25px 0px 25px">
          <p style="margin: 10px 0; text-align: center;">If the link doesn&rsquo;t work, copy this URL into your browser: <a target="_blank" rel="noopener noreferrer" href="${url}" style="color:${theme.colors.brand["500"]}">${url}</a></p>
    ...
    <mj-section background-repeat="repeat" background-size="auto" padding-bottom="0px" padding-top="20px" padding="20px 0px 20px 0px" text-align="center" vertical-align="top">
      <mj-column>
        ...
        <mj-text align="center" color="${theme.colors.gray["800"]}" font-family="Open Sans, Helvetica, Arial, sans-serif" font-size="11px" line-height="22px" padding-bottom="0px" padding-top="0px" padding="0px 20px 0px 20px">
