...
export const generateHtml = (props: {
  ...
  return mjml2html(
    ...
    <mj-body background-color="${theme.colors.gray["100"]}" color="${
      ...
      <mj-section background-repeat="repeat" background-size="auto" padding-bottom="0px" padding-top="0px" padding="20px 0px 20px 0px" text-align="center" vertical-align="top">
        <mj-column>
          <mj-text align="left" color="${
            theme.colors.gray["800"]
          }" font-familyInter,="Inter, Open Sans, Helvetica, Arial, sans-serif" font-size="11px" line-height="22px" padding-bottom="0px" padding-top="0px" padding="0px 0px 0px 25px">
            <p style="text-align: center; margin: 10px 0;">LabelFlow invitation&nbsp;| <a target="_blank" rel="noopener noreferrer" href="${viewOnlineLink}"><span style="color:${
      theme.colors.gray["800"]
    }; text-decoration: underline"> View online version</span></a></p>
          </mj-text>
        </mj-column>
      </mj-section>
      <mj-section background-color="#ffffff" background-repeat="repeat" padding-bottom="0px" padding-left="0px" padding-right="0px" padding-top="0px" padding="20px 0" text-align="center" vertical-align="top">
        <mj-column>
          ...
          }" border-style="solid" border-width="7px" padding-bottom="40px" padding-left="0px" padding-right="0px" padding-top="0px" padding="10px 25px" width="100%"></mj-divider>
      ...
      inviterEmail ? `(${inviterEmail})` : ""
          ...
          <mj-text align="left" color="${
            ...
            <p style="margin: 10px 0; text-align: center;">If the link doesn&rsquo;t work, copy this URL into your browser:</br> <a target="_blank" rel="noopener noreferrer" href="${url}" style="color:${
      theme.colors.brand["500"]
    }">${url}</a></p>
          </mj-text>
        </mj-column>
      ...
      <mj-section background-repeat="repeat" background-size="auto" padding-bottom="0px" padding-top="20px" padding="20px 0px 20px 0px" text-align="center" vertical-align="top">
        <mj-column>
          <mj-social align="center" border-radius="6px" font-family="Ubuntu, Helvetica, Arial, sans-serif" font-size="13px" icon-size="30" line-height="22px" mode="horizontal" padding-bottom="0px" padding="10px 25px" text-decoration="none" text-mode="true">
            <mj-social-element background-color="${
              theme.colors.brand["500"]
            }" href="https://www.facebook.com/Labelflow" name="facebook-noshare" src="http://www.mailjet.com/saas-templates-creator/static/img/facebook_white.png"></mj-social-element>
            <mj-social-element background-color="${
              theme.colors.brand["500"]
            }" href="https://twitter.com/LabelflowAI" name="twitter-noshare" src="http://www.mailjet.com/saas-templates-creator/static/img/twitter_white.png"></mj-social-element>
            <mj-social-element background-color="${
              theme.colors.brand["500"]
            }" href="https://www.linkedin.com/company/labelflow/" name="linkedin-noshare" src="http://www.mailjet.com/saas-templates-creator/static/img/linkedin_white.png"></mj-social-element>
          </mj-social>
          <mj-text align="center" color="${
            theme.colors.gray["800"]
          }" font-familyInter,="Inter, Open Sans, Helvetica, Arial, sans-serif" font-size="11px" line-height="22px" padding-bottom="0px" padding-top="0px" padding="0px 20px 0px 20px">
            <!-- <p style="margin: 10px 0;"><a target="_blank" rel="noopener noreferrer" style="color:${
              theme.colors.brand["500"]
            }" href="#"><span style="color:${
      theme.colors.brand["500"]
    }">Page 1</span></a><span style="color:${
      theme.colors.gray["800"]
    }">&nbsp; &nbsp;|&nbsp; &nbsp;</span><a target="_blank" rel="noopener noreferrer" style="color:${
      theme.colors.brand["500"]
    }" href="#"><span style="color:${
      theme.colors.brand["500"]
    }">Page 2</span></a><span style="color:${
      theme.colors.gray["800"]
    }">&nbsp; &nbsp;|&nbsp; &nbsp;</span><a target="_blank" rel="noopener noreferrer" style="color:${
      theme.colors.brand["500"]
    }" href="#"><span style="color:${
      theme.colors.brand["500"]
            ...
            <!-- <p style="margin: 10px 0;">C<a target="_blank" rel="noopener noreferrer" style="color:inherit; text-decoration:none" href="[[UNSUB_LINK_EN]]">lick <span style="color:${
              theme.colors.brand["500"]
            }"><u>here</u></span> to unsubscribe</a>.<br /><span style="font-size:10px">Created by&nbsp;</span><a target="_blank" rel="noopener noreferrer" style="font-size:10px; color:inherit; text-decoration: none" href="https://www.mailjet.com/?utm_source=saas_email_templates&amp;utm_medium=logo_footer_email&amp;utm_campaign=account_activation"><span style="color:${
      theme.colors.brand["500"]
    }"><u>Mailjet</u></span></a></p> -->
          </mj-text>
        </mj-column>
      </mj-section>
    </mj-body>
