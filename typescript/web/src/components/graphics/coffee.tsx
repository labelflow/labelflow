...
function SvgCoffee(
  ...
  return (
    ...
    >
      <defs>
        <style>
          {".coffee_svg__cls-1{fill:#dee1e7}.coffee_svg__cls-2{fill:#b8c0ce}"}
        </style>
      </defs>
      <path
        className="coffee_svg__cls-1"
        d="M75 90H21L4 88.3A3.32 3.32 0 011 85h94a3.32 3.32 0 01-3 3.3z"
      />
      <path className="coffee_svg__cls-2" d="M73 95H23l-2-5h54l-2 5z" />
      <path
