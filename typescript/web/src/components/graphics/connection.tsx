  ...
  return (
    ...
    >
      <defs>
        <style>
          {
            ".connection_svg__cls-1{fill:#6a6e86}.connection_svg__cls-2{fill:#8288a1}.connection_svg__cls-3{fill:#969cb2}.connection_svg__cls-5{fill:#797c92}.connection_svg__cls-6{fill:#f6b756}.connection_svg__cls-7{fill:#aeb4c6}.connection_svg__cls-8{fill:#c6ccda}.connection_svg__cls-9{fill:#39426a}"
          }
        </style>
      </defs>
      <path
        className="connection_svg__cls-1"
        d="M6 90h14v5H6zM76 90h14v5H76z"
      />
      <path
        className="connection_svg__cls-2"
        d="M95 68v18a4.43 4.43 0 01-.1.9A4 4 0 0191 90H5a4 4 0 01-4-4V68a4 4 0 013.1-3.9A4.43 4.43 0 015 64h86a4 4 0 014 4z"
      />
      <path
        className="connection_svg__cls-3"
      ...
      <circle className="connection_svg__cls-1" cx={13} cy={77} r={6} />
      <circle className="connection_svg__cls-5" cx={13} cy={77} r={3} />
      <circle className="connection_svg__cls-6" cx={30} cy={77} r={3} />
      <circle className="connection_svg__cls-6" cx={42} cy={77} r={3} />
      <circle className="connection_svg__cls-6" cx={54} cy={77} r={3} />
      <circle className="connection_svg__cls-6" cx={66} cy={77} r={3} />
      <circle className="connection_svg__cls-1" cx={83} cy={77} r={6} />
      <circle className="connection_svg__cls-5" cx={83} cy={77} r={3} />
      <rect
        className="connection_svg__cls-7"
        x={23}
        y={67}
        width={69}
        height={4}
      ...
      />
      <path
        className="connection_svg__cls-8"
        d="M14 32V3a2 2 0 00-2-2 2 2 0 00-2 2v29L9 56h6zM86 32V3a2 2 0 00-2-2 2 2 0 00-2 2v29l-1 24h6z"
      />
      <circle className="connection_svg__cls-6" cx={48} cy={43} r={3} />
      <path
        className="connection_svg__cls-6"
      ...
      />
      <path
        className="connection_svg__cls-9"
      ...
      />
      <circle className="connection_svg__cls-7" cx={18} cy={69} r={2} />
    </svg>
  );
}

const ForwardRef = React.forwardRef(SvgConnection);
