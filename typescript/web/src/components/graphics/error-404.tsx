...
function SvgError404(
  props: React.SVGProps<SVGSVGElement>,
  svgRef?: React.Ref<SVGSVGElement>
) {
  return (
    <svg
      id="error-404_svg__Layer_1"
      data-name="Layer 1"
    ...
    >
      <defs>
        <style>
          {
            ".error-404_svg__cls-11{fill:#cf4055}.error-404_svg__cls-14{fill:#c3e1f5}.error-404_svg__cls-16{fill:#dee1e7}.error-404_svg__cls-17{fill:#39426a}"
          }
        </style>
      </defs>
      ...
      <circle className="error-404_svg__cls-11" cx={14} cy={12} r={2} />
      <circle cx={24} cy={12} r={2} fill="#f6b756" />
      <circle cx={34} cy={12} r={2} fill="#85bd79" />
      <rect
        className="error-404_svg__cls-14"
        x={50}
        y={9}
        width={37}
        height={4}
        rx={2}
      />
      <circle className="error-404_svg__cls-14" cx={45} cy={11} r={2} />
      <path d="M3 65h89v5a4 4 0 01-4 4H7a4 4 0 01-4-4v-5z" fill="#ccd1dc" />
      <rect
        className="error-404_svg__cls-16"
        x={14}
        y={68}
        width={76}
        height={4}
      ...
      />
      <path
        className="error-404_svg__cls-17"
      ...
      />
      <circle className="error-404_svg__cls-16" cx={8} cy={70} r={2} />
      <path
        className="error-404_svg__cls-17"
      ...
      />
      <path
        className="error-404_svg__cls-11"
...
const ForwardRef = React.forwardRef(SvgError404);
