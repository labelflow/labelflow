  ...
  return (
    ...
    >
      <defs>
        <style>
          {
            ".image_svg__cls-1{fill:#ccd1dc}.image_svg__cls-2{fill:#dee1e7}.image_svg__cls-3{fill:#f3f4f5}.image_svg__cls-4{fill:#abd9e6}.image_svg__cls-7{fill:#c3e1f5}.image_svg__cls-8{fill:#85bd79}.image_svg__cls-9{fill:#9fc98a}.image_svg__cls-10{fill:#f6b756}.image_svg__cls-11{fill:#fac77d}.image_svg__cls-12{fill:#39426a}"
          }
        </style>
      </defs>
      <path
      ...
      />
      <path
        className="image_svg__cls-7"
        d="M87.39 23l-7 26.08c-24-6.43-40.34-23.32-36.48-37.73z"
      />
      <path className="image_svg__cls-1" d="M1 27h60v70H1z" />
      <path className="image_svg__cls-2" d="M61 27v67H16A12 12 0 014 82V27z" />
      <rect
        className="image_svg__cls-3"
        x={31}
        y={30}
        ...
        rx={2}
      />
      <path className="image_svg__cls-4" d="M7 33h48v48H7z" />
      <path
        className="image_svg__cls-8"
