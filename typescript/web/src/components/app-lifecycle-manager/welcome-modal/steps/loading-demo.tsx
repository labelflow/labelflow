...
export const LoadingDemo = ({ startLabellingButtonRef }: Props) => {
  return (
    <ModalContent margin="3.75rem">
      ...
      <ModalBody>
        <VStack
          ...
          mb="8"
        >
          <Image src={gift} p={10} width="16em" height="16em" />
          <Heading
            as="h1"
            size="2xl"
            maxW="lg"
          ...
          <Text
            ...
            textAlign="justify"
          >
            The application is creating a demo dataset to get you started, this
