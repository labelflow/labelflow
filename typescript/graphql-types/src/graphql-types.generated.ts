...
export type ResolversTypes = {
  ...
  UploadTarget:
    | ResolversTypes["UploadTargetDirect"]
    | ResolversTypes["UploadTargetHttp"];
...
export type ResolversParentTypes = {
  ...
  UploadTarget:
    | ResolversParentTypes["UploadTargetDirect"]
    | ResolversParentTypes["UploadTargetHttp"];
...
export interface ColorHexScalarConfig
  extends GraphQLScalarTypeConfig<ResolversTypes["ColorHex"], any> {
  name: "ColorHex";
}

export type DatasetResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Dataset"] = ResolversParentTypes["Dataset"]
> = {
  ...
  images?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<DatasetImagesArgs>
  >;
  imagesAggregates?: Resolver<
    ResolversTypes["ImagesAggregates"],
    ParentType,
    ContextType
  >;
  labelClasses?: Resolver<
    Array<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType
  >;
  labelClassesAggregates?: Resolver<
    ResolversTypes["LabelClassesAggregates"],
    ParentType,
    ContextType
  >;
  labels?: Resolver<Array<ResolversTypes["Label"]>, ParentType, ContextType>;
  labelsAggregates?: Resolver<
    ResolversTypes["LabelsAggregates"],
    ParentType,
    ContextType
  >;
...
export type ExampleResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Example"] = ResolversParentTypes["Example"]
> = {
  createdAt?: Resolver<
...
> = {
  ...
  thumbnail20Url?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  thumbnail50Url?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  thumbnail100Url?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  thumbnail200Url?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  thumbnail500Url?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
export type ImagesAggregatesResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ImagesAggregates"] = ResolversParentTypes["ImagesAggregates"]
> = {
  totalCount?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ImportStatusResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ImportStatus"] = ResolversParentTypes["ImportStatus"]
> = {
...
> = {
  ...
  labelClass?: Resolver<
    Maybe<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType
  >;
  smartToolInput?: Resolver<
...
export type LabelClassResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["LabelClass"] = ResolversParentTypes["LabelClass"]
> = {
...
export type LabelClassesAggregatesResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["LabelClassesAggregates"] = ResolversParentTypes["LabelClassesAggregates"]
> = {
  totalCount?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LabelsAggregatesResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["LabelsAggregates"] = ResolversParentTypes["LabelsAggregates"]
> = {
  totalCount?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
> = {
  createdAt?: Resolver<ResolversTypes["DateTime"], ParentType, ContextType>;
  currentUserCanAcceptInvitation?: Resolver<
    ResolversTypes["CurrentUserCanAcceptInvitation"],
    ParentType,
    ContextType
  >;
  declinedAt?: Resolver<
  ...
  >;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  invitationEmailSentTo?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
> = {
  acceptInvitation?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAcceptInvitationArgs, "where">
  >;
  createDataset?: Resolver<
    Maybe<ResolversTypes["Dataset"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateDatasetArgs, "data">
  >;
  createExample?: Resolver<
    Maybe<ResolversTypes["Example"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateExampleArgs, "data">
  >;
  ...
  >;
  createIogLabel?: Resolver<
    Maybe<ResolversTypes["Label"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateIogLabelArgs, "data">
  >;
  createLabel?: Resolver<
    Maybe<ResolversTypes["Label"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateLabelArgs, "data">
  >;
  createLabelClass?: Resolver<
    Maybe<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateLabelClassArgs, "data">
  >;
  createManyImages?: Resolver<
    Array<ResolversTypes["Image"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateManyImagesArgs, "data">
  >;
  createManyLabelClasses?: Resolver<
    Array<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateManyLabelClassesArgs, "data">
  >;
  createMembership?: Resolver<
    Maybe<ResolversTypes["Membership"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateMembershipArgs, "data">
  >;
  createWorkspace?: Resolver<
    Maybe<ResolversTypes["Workspace"]>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateWorkspaceArgs, "data">
  >;
  declineInvitation?: Resolver<
    Maybe<ResolversTypes["Membership"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDeclineInvitationArgs, "where">
  >;
  deleteDataset?: Resolver<
    Maybe<ResolversTypes["Dataset"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteDatasetArgs, "where">
  >;
  ...
  deleteLabel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationDeleteLabelArgs, "where">
  >;
  deleteLabelClass?: Resolver<
    Maybe<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteLabelClassArgs, "where">
  >;
  deleteMembership?: Resolver<
    Maybe<ResolversTypes["Membership"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteMembershipArgs, "where">
  >;
  deleteWorkspace?: Resolver<
    Maybe<ResolversTypes["Workspace"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteWorkspaceArgs, "where">
  >;
  getUploadTarget?: Resolver<
    ResolversTypes["UploadTarget"],
    ParentType,
    ContextType,
    RequireFields<MutationGetUploadTargetArgs, "data">
  >;
  importDataset?: Resolver<
    Maybe<ResolversTypes["ImportStatus"]>,
    ParentType,
    ContextType,
    RequireFields<MutationImportDatasetArgs, "data" | "where">
  >;
  inviteMember?: Resolver<
    Maybe<ResolversTypes["InvitationResult"]>,
    ParentType,
    ContextType,
    RequireFields<MutationInviteMemberArgs, "where">
  >;
  reorderLabelClass?: Resolver<
    Maybe<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType,
    RequireFields<MutationReorderLabelClassArgs, "data" | "where">
  >;
  updateDataset?: Resolver<
    Maybe<ResolversTypes["Dataset"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateDatasetArgs, "data" | "where">
  >;
  ...
  >;
  updateIogLabel?: Resolver<
    Maybe<ResolversTypes["Label"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateIogLabelArgs, "data">
  >;
  updateLabel?: Resolver<
    Maybe<ResolversTypes["Label"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateLabelArgs, "data" | "where">
  >;
  updateLabelClass?: Resolver<
    Maybe<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateLabelClassArgs, "data" | "where">
  >;
  updateMembership?: Resolver<
    Maybe<ResolversTypes["Membership"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateMembershipArgs, "data" | "where">
  >;
  updateUser?: Resolver<
  ...
  updateWorkspace?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateWorkspaceArgs, "data" | "where">
  >;
};
...
> = {
  dataset?: Resolver<
    ResolversTypes["Dataset"],
    ParentType,
    ContextType,
    RequireFields<QueryDatasetArgs, "where">
  >;
  datasets?: Resolver<
    Array<ResolversTypes["Dataset"]>,
    ParentType,
    ContextType,
    Partial<QueryDatasetsArgs>
  >;
  ...
  example?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryExampleArgs, "where">
  >;
  examples?: Resolver<
    Array<ResolversTypes["Example"]>,
    ParentType,
    ContextType,
    Partial<QueryExamplesArgs>
  >;
  exportDataset?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType,
    RequireFields<QueryExportDatasetArgs, "format" | "where">
  >;
  ...
  >;
  labelClass?: Resolver<
    ResolversTypes["LabelClass"],
    ParentType,
    ContextType,
    RequireFields<QueryLabelClassArgs, "where">
  >;
  labelClassExists?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<QueryLabelClassExistsArgs, "where">
  >;
  labelClasses?: Resolver<
    Array<ResolversTypes["LabelClass"]>,
    ParentType,
    ContextType,
    Partial<QueryLabelClassesArgs>
  >;
  labelClassesAggregates?: Resolver<
    ResolversTypes["LabelClassesAggregates"],
    ParentType,
  ...
  >;
  membership?: Resolver<
    ResolversTypes["Membership"],
    ParentType,
    ContextType,
    RequireFields<QueryMembershipArgs, "where">
  >;
  ...
  >;
  searchDataset?: Resolver<
    Maybe<ResolversTypes["Dataset"]>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchDatasetArgs, "where">
  >;
  user?: Resolver<
    ResolversTypes["User"],
    ParentType,
  ...
  workspace?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryWorkspaceArgs, "where">
  >;
  workspaceExists?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<QueryWorkspaceExistsArgs, "where">
  >;
  workspaces?: Resolver<
    Array<ResolversTypes["Workspace"]>,
    ParentType,
    ContextType,
    Partial<QueryWorkspacesArgs>
  >;
};
...
export type UploadTargetResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["UploadTarget"] = ResolversParentTypes["UploadTarget"]
> = {
  __resolveType: TypeResolveFn<
    "UploadTargetDirect" | "UploadTargetHttp",
    ParentType,
    ContextType
  >;
};

export type UploadTargetDirectResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["UploadTargetDirect"] = ResolversParentTypes["UploadTargetDirect"]
> = {
  direct?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UploadTargetHttpResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["UploadTargetHttp"] = ResolversParentTypes["UploadTargetHttp"]
> = {
...
> = {
  ...
  slug?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  stripeCustomerPortalUrl?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
